...
// list cmd registers from — rather than naming ask_gemini, so a tool added
// later is asserted over without anyone remembering to extend this file.
//
...
// (TestAskGeminiHandler_RejectsUnknownField).
